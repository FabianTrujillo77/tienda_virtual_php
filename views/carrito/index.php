...
<?php if(isset($_SESSION['carrito']) && count($_SESSION['carrito']) >=1) :?>
    <table>
        ...
        ?>
            ...
            <tr>
                ...
                <td><a href="<?=base_url?>carrito/delete&index=<?=$indice?>" class="button button_carrito button_red">Quitar producto</a></td>
            </tr>
        <?php endforeach ; ?>
    </table>
    <br>
    ...
    <div class="delete_carrito">
        <a href="<?=base_url?>carrito/delete_all" class="button button_delete button_red">Vaciar carrito</a>
    </div>
...
<?php else : ?>
    <p>El carrito està vacio, añade algun producto</p>
<?php endif ; ?>
